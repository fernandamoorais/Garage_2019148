...
$address2 = e($_POST['addres2']);
 $password = e($_POST['password']);
 $password2 = e($_POST['password2']);
 $birthday = e($_POST['birthday']);
 $phone = e($_POST['$phone']);
 $eircode = e($_POST['$eircode']);
  ...
  if ($password != $password2) {
	...
	if (count($errors) == 0) {
		...
		if (isset($_POST['user_type'])) {
			$user_type = e($_POST['user_type']);
			$query = "INSERT INTO user (username, first_name, last_name, address, address2, password, password2,birthday, phone, eircode,user_type) 
					  VALUES ('$username', '$first_name', '$last_name', '$address','$address2', '$password', '$password2','$birthday', '$phone', '$eircode','$user_type')";
			mysqli_query($db, $query);
			$_SESSION['success']  = "New user successfully created!!";
      header('location: adm.php');
		}else{
			$query = "INSERT INTO user (username, first_name, last_name, address, address2, password, password2,birthday, phone, eircode,user_type) 
					  VALUES ('$username', '$first_name', '$last_name', '$address','$address2', '$password', '$password2','$birthday', '$phone', '$eircode','$user_type')";mysqli_query($db, $query);
